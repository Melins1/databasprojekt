...
--
/*!50003 DROP FUNCTION IF EXISTS `AvgReleaseYearByGenre` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `AvgReleaseYearByGenre`(genre_search VARCHAR(50)) RETURNS int
    DETERMINISTIC
BEGIN
    DECLARE avg_year INT;
    SELECT AVG(Movie.Release_Year) INTO avg_year
    FROM Movie
    JOIN Movie_Genre ON Movie.Movie_ID = Movie_Genre.Movie_ID
    JOIN Genre ON Movie_Genre.Genre_ID = Genre.Genre_ID
    WHERE Genre.Name = genre_search;
    RETURN avg_year;
END ;;
DELIMITER ;
...
/*!50003 DROP PROCEDURE IF EXISTS `SearchMovieByTitle` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `SearchMovieByTitle`(IN title_search VARCHAR(255))
BEGIN
    ...
    WHERE Movie.Title LIKE CONCAT('%', title_search, '%')
